...
namespace ServiceSchedulerTests
{
	...
	public class ParseTimeTest
	{
        ...
        [TestCase(2015, 9, 21, 9, 34, null, "Monday")] //day before now; scheduling for the next week
        [TestCase(2015, 9, 15, 9, 34, null, "Tuesday")] //day matches now
        [TestCase(2015, 9, 16, 9, 34, null, "Wednesday")]
        public void ParseValidStopTimeWithoutTime(int expectedYear, int expectedMonth, int expectedDay, int expectedHour, int expectedMinute, string dateTime, string dayOfWeek)
        {
            ...
            var expected = new DateTime(expectedYear, expectedMonth, expectedDay, expectedHour, expectedMinute, 59);
